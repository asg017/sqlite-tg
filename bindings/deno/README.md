...
[![Doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sqlite-tg@0.0.1-alpha.1/mod.ts)
...
import * as sqlite_tg from "https://deno.land/x/sqlite_tg@v0.0.1-alpha.1/mod.ts";
