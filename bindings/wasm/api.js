...
Module["onRuntimeInitialized"] = function onRuntimeInitialized() {
  ...
  var sqlite3_exec = cwrap("sqlite3_exec", "number", [
    "number",
    "string",
    "number",
    "number",
  ...
  var sqlite3_normalized_sql = cwrap("sqlite3_normalized_sql", "string", [
    "number",
  ]);
  var sqlite3_prepare_v2_sqlptr = cwrap("sqlite3_prepare_v2", "number", [
    "number",
    "number",
    "number",
    "number",
  ...
  var sqlite3_column_blob = cwrap("sqlite3_column_blob", "number", [
    "number",
    "number",
  ]);
  ...
  var sqlite3_value_double = cwrap("sqlite3_value_double", "number", [
    "number",
  ]);
  var sqlite3_result_double = cwrap("sqlite3_result_double", "", [
    "number",
    "number",
  ]);
  var sqlite3_result_null = cwrap("sqlite3_result_null", "", ["number"]);
  var sqlite3_result_text = cwrap("sqlite3_result_text", "", [
    "number",
    "string",
    "number",
    "number",
  ]);
  var sqlite3_result_blob = cwrap("sqlite3_result_blob", "", [
    "number",
    "number",
    "number",
    "number",
  ]);
  var sqlite3_result_int = cwrap("sqlite3_result_int", "", [
    "number",
    "number",
  ]);
  var sqlite3_result_error = cwrap("sqlite3_result_error", "", [
    "number",
    "string",
    "number",
  ]);
  ...
  Statement.prototype.bindNumber = function bindNumber(num, pos) {
    ...
    var bindfunc = num === (num | 0) ? sqlite3_bind_int : sqlite3_bind_double;
